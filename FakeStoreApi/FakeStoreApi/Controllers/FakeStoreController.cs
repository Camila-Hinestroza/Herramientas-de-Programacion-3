...
namespace FakeStoreApi.Controllers
{
    ...
    [Route("/api/FakeStore")] // Especifica la ruta base para las solicitudes HTTP que serán manejadas por este controlador. En este caso, la ruta base será "/api/FakeStore".
    public class FakeStoreController : ControllerBase 
    {
        ...
        [HttpGet("/api/FakeStore/products")] // Define un método de acción HTTP GET que responde a las solicitudes HTTP en la ruta "/api/FakeStore/products".
